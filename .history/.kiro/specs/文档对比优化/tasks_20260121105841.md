...
- [x] 1. 创建 TextNormalizer 组件
  - [x] 1.1 实现 TextNormalizer 类
  ...
  - [x] 1.2 为 TextNormalizer 编写属性测试
    - **属性 1: 规范化保持幂等性**
    - **验证需求: 1.5**

  - [x] 1.3 为 TextNormalizer 编写属性测试
    - **属性 2: 规范化移除格式保留内容**
    - **验证需求: 1.2, 1.3, 1.4**

  - [x] 1.4 为 TextNormalizer 编写单元测试
    - 测试边界情况：空字符串、纯空白、null/undefined
    - 测试特殊字符处理
    - _需求: 1.1_

- [x] 2. 优化 DiffEngine
  - [x] 2.1 集成 TextNormalizer 到 DiffEngine
...
- [x] 4. 重构 SimilarityCalculator
  ...
  - [x] 4.6 为 SimilarityCalculator 编写单元测试
    - 测试 LCS 边界情况
    - 测试空文档处理
    - 测试除零保护
    - _需求: 3.5_
...
- [x] 5. 增强 FileParser
  ...
  - [x] 5.2 为 Excel 解析编写属性测试
    - **属性 11: Excel 单元格清理**
    - **验证需求: 5.1, 5.2**

  - [x] 5.3 为 Excel 解析编写属性测试
    - **属性 12: Excel 行格式一致性**
    - **验证需求: 5.3, 5.4**
  ...
  - [x] 5.5 为 Word 解析编写属性测试
    - **属性 13: Word 格式忽略**
    - **验证需求: 6.1, 6.3**

  - [x] 5.6 为 Word 解析编写属性测试
    - **属性 14: Word 段落结构保留**
    - **验证需求: 6.2, 6.4**

  - [x] 5.7 为 FileParser 编写单元测试
    - 测试文件格式错误处理
    - 测试边界情况
